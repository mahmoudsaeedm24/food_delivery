...
import 'package:food_delivery/features/personal_data/data/update_user_repo.dart';
...
class UpdateUserCubit extends Cubit<UpdateUserState> {
  ...
  Future<void> updateUser({required UserModel userModel}) async {
    ...
    either.fold((e) => emit(UpdateUserFailed(e: e)), (user) => emit(UpdateUserUpdated(user: user)), );    
  }
}
