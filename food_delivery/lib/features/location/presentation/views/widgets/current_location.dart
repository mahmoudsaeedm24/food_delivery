...
import 'package:food_delivery/core/components/data/data_sources/shared_pref_data_base/location_data_source.dart';
import 'package:food_delivery/core/utils/extensions/lat_lng_extension.dart';
import 'package:food_delivery/core/utils/extensions/position_extension.dart';
          ...
          onLongPress: (tapPosition, point) async {
            ...
            if (!res){
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text("refused store location")),
              );
